...
const Header = ()=> {
    ...
    <header className="header dark-bg">
      <div className="toggle-nav">
        <div className="icon-reorder tooltips" data-original-title="Toggle Navigation" data-placement="bottom"><i class="icon_menu"></i></div>
      </div>
          ...
          <li id="task_notificatoin_bar" className="dropdown">
            ...
            <ul className="dropdown-menu extended tasks-bar">
              ...
              <li>
                <a href="/">
                  ...
                  <div className="progress progress-striped active">
                    <div className="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="78" aria-valuemin="0" aria-valuemax="100" >
           ...
           <li id="mail_notificatoin_bar" className="dropdown">
            ...
            <ul className="dropdown-menu extended inbox">
              ...
              <li>
                <a href="/">
                  <span className="photo"><img alt="avatar" src="assets/img/avatar-mini.jpg"></img></span>
              ...
              <li>
                <a href="/">
                  <span className="photo"><img alt="avatar" src="assets/img/avatar-mini2.jpg"></img></span>
                  <span className="subject">
              ...
              <li>
                <a href="/">
                  <span className="photo"><img alt="avatar" src="assets/img/avatar-mini3.jpg"></img></span>
                  <span className="subject">
              ...
              <li>
                <a href="/">
                  <span className="subject">
                  <span className="photo"><img alt="avatar" src="assets/img/avatar-mini4.jpg"></img></span>
          ...
          <li id="alert_notificatoin_bar" className="dropdown">
            <a data-toggle="dropdown" className="dropdown-toggle" href="/">
              <i className="icon-bell-l"></i>
                <span className="badge bg-important">10</span>
            </a>
          ...
          <li className="dropdown">
            <a data-toggle="dropdown" className="dropdown-toggle" href="/">
              <span className="profile-ava">
                <img alt="" src="assets/img/avatar1_small.jpg"></img>
              </span>
